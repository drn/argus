...
// ParseGitStatus delegates to gitutil.ParseGitStatus.
func ParseGitStatus(output string) []ChangedFile {
	return gitutil.ParseGitStatus(output)
}

// ParseGitDiffNameStatus delegates to gitutil.ParseGitDiffNameStatus.
func ParseGitDiffNameStatus(output string) []ChangedFile {
	return gitutil.ParseGitDiffNameStatus(output)
}

// MergeChangedFiles delegates to gitutil.MergeChangedFiles.
func MergeChangedFiles(base, overlay []ChangedFile) []ChangedFile {
	return gitutil.MergeChangedFiles(base, overlay)
}
