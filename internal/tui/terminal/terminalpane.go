...
//
// Delivered via WriteInputSystem, NOT WriteInput: this response is
// auto-generated by the emulator, never the user answering a prompt. Using
// WriteInput would stamp lastUserInput exactly like a real keystroke, which
