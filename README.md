...
- **Seed profiles** – three documented examples ship under `docs/profiles/` (they are examples, **not** auto-installed – copy one to `~/.argus/profiles/` or a repo's `.argus/profiles/` and adapt):
