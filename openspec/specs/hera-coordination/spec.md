...
It SHALL continue to require a coordinator caller and transactionally create the task, worker role, and binding; preserve compensating cleanup; default the project and archetype as documented; and support materializing a pre-created planned role.
...
#### Scenario: Existing transactional worker-spawn behavior remains intact

- **WHEN** a coordinator spawns or materializes a worker
- **THEN** the existing role-binding, cleanup, project inheritance, and archetype behavior applies
