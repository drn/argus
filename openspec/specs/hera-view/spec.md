...
- **WHEN** at least one role in an orchestrator's bridge subtree has an accrued cost
...
- **WHEN** no role in an orchestrator's bridge subtree has any accrued cost (all unmeasured or all resolved to uncurated models)
