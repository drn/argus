...
- **`docs-check`** — a guarded doc (e.g. `CLAUDE.md`) exceeded its line cap. Trim it — move detail into `context/knowledge/gotchas/*` — or consciously raise the cap in `scripts/docsize/main.go`.
