...
| File | Topic | Bullets |
|------|-------|---------|
| [gotchas/daemon-rpc.md](gotchas/daemon-rpc.md) | Daemon lifecycle, RPC timeouts, reconciliation races, session resume, binary staleness | 27 |
...
| [gotchas/ui-threading.md](gotchas/ui-threading.md) | tview thread safety, tick goroutine rules, lazyScreen fill invariant, paste/input batching | 15 |
...
| [gotchas/web-remote.md](gotchas/web-remote.md) | SPA + REST API + service worker, EventSource auth, xterm.js, HTML escaping, virtual keys, detail-view layout, Web Push, per-device tokens, test harness | 30 |
